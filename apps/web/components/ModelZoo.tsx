                ...
                {PRESETS.map((p, i) => (
                    ...
                    >
                        <div className="flex justify-between items-center mb-1">
                            <span className="font-mono text-xs font-bold text-white group-hover:text-brand-primary">{p.name}</span>
                            <span className="text-[10px] text-brand-secondary bg-brand-secondary/10 px-1 rounded">PRESET</span>
                        </div>
